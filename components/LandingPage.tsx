import { Agents, AgentsText, Agents_brokersText, Box, BrokerBoxContainer, BuyersContainer, BuyersText, Coming, ComingSoonContainer, DevelopersText, ForBuyers, ForBuyersText, ForText, GetBtn, Header1, Header2, Img2container, ImgContainer, LandingPageContainer, Line, Line2, Offers, Provides, Rec1, Rec25, Rec28, Rec29, Rectangle24, SmallContainer, Soon, StreamliningContainer, StreamliningHeader, Text, Why, WhyContainer, WhyText } from '@/styles/LandingPage';
        ...
        <WhyContainer>
            ...
            <Rec1>
                <ForText>FOR REAL ESTATE
                    <DevelopersText>DEVELOPERS</DevelopersText>
          </ForText>
            ...
            <Rec25>
                ...
                <Agents>
                    <AgentsText>FOR REAL ESTATE
                        <Agents_brokersText>AGENTS,BROKERS</Agents_brokersText>
                    </AgentsText>
